...
const ManSymptomsOwn = () => {
  ...
  return (
    <Layout title="Mis Síntomas" showBackButton={false}>
      <div className="space-y-6">
        ...
        <button
          onClick={handleSave}
          className="w-full bg-gradient-to-r from-blue-500 to-indigo-500 text-white py-4 rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all flex items-center justify-center space-x-2"
        >
          <Heart size={20} />
      ...
      >
        ...
        <button
          ...
          className="w-full mt-4 bg-blue-500 text-white py-3 rounded-xl font-semibold hover:bg-blue-600 transition-colors"
        >
          Aceptar
        </button>
      </Modal>
